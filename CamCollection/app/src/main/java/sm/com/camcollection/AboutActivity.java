...
public class AboutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.appVersion)).setText(BuildConfig.APPLICATION_ID);
        ((TextView)findViewById(R.id.appVersion)).setText(BuildConfig.VERSION_NAME);
        ((TextView)findViewById(R.id.githubURL1)).setMovementMethod(LinkMovementMethod.getInstance());
        ((TextView)findViewById(R.id.githubURL2)).setMovementMethod(LinkMovementMethod.getInstance());
    }
